...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    copy_mode_easymotion: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    copy_mode_scroll_up: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    open_pane_left: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    open_pane_down: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    open_pane_up: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    open_pane_right: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'de> Deserialize<'de> for KeysConfig {
        ...
        D: Deserializer<'de>,
    {
        ...
        apply_field!(open_pane_left);
        apply_field!(open_pane_down);
        apply_field!(open_pane_up);
        apply_field!(open_pane_right);
...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_user_field!(chord_timeout_ms);
        ...
        copy_effective_action_field!(open_pane_left, keybinds.open_pane_left);
        copy_effective_action_field!(open_pane_down, keybinds.open_pane_down);
        copy_effective_action_field!(open_pane_up, keybinds.open_pane_up);
        copy_effective_action_field!(open_pane_right, keybinds.open_pane_right);
