...
mod tests {
    ...
    fn host_keyboard_report_all_replaces_the_current_herdr_stack_entry() {
        ...
        // The fork's static host flags already include report-all-keys and the
        // associated-text bit, so both replacement entries use the same flags.
        assert_eq!(output, b"\x1b[<1u\x1b[>31u\x1b[<1u\x1b[>31u");
    }
