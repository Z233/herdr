...
The z233 fork also adds prefix chords, four-direction pane opening, a preview workspace picker, MRU quick switching, EasyMotion copy jumps, and enhanced IME input. See [`docs/FORK_FEATURES.md`](../FORK_FEATURES.md).
